                      ...
                      >
                        <div className="flex flex-wrap items-start justify-between gap-2">
                          ...
                          >
                            ...
                            <span className="min-w-0 text-sm font-semibold text-[#244535]">
                          ...
                          {isSelectedOwned ? (
                            <div className="flex flex-wrap gap-2">
                              <button
                                type="button"
                                className="rounded-full border border-[#d2e3cf] bg-white px-2.5 py-1 text-xs font-semibold text-[#325f41] disabled:opacity-50"
